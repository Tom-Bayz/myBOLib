...
def PBO_EI(X,Y,WorkerN=1,T=50,seed=0,init_dataN=1):
    ...
    PBO.set_logINFO(dir_name="./",file_name="ei_test.csv",interval=3)
...
if __name__ == "__main__":
    ...
    PBO_EI(X,Y,init_dataN=2,T=50,WorkerN=2,seed=44)

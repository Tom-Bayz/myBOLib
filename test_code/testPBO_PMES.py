...
def PBO_PMES(X,Y,WorkerN=1,T=50,seed=0,init_dataN=1):
    ...
    PBO.set_logINFO(dir_name="./",file_name="pmes_test.csv",interval=3)
...
if __name__ == "__main__":
    ...
    PBO_PMES(X,Y,init_dataN=2,T=2,WorkerN=1,seed=44)
